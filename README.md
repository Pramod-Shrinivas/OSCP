# OSCP Preparation: TJNULL List — Kioptrix Level 1.1 Walkthrough
...
Updated Kioptrix Level 1.1 Machine IP -> 192.168.1.4
...
**Exploitation:** Let’s go ahead and type in: Basically telling the system to run **ping** against our attacker machine (192.168.1.7), then run the file listing "**ls-l"** command. Technically the “**;**” symbol is a command separator.
